...
from cs102.homework07.async_http import AsyncServer, AsyncHTTPRequestHandler


class AsyncWSGIServer(AsyncServer):
...
class AsyncWSGIRequestHandler(AsyncHTTPRequestHandler):
    ...
    def __init__(self, sock, application):
        AsyncHTTPRequestHandler.__init__(self, sock)
        self.application = application
